...
<body class="admin-dashboard-page">
                ...
                <div class="card-body p-4 position-relative">
                  ...
                  <div class="mt-3">
                      ...
                      <div class="d-flex align-items-center mb-2">
                        ...
                        <small class="text-muted">Returned: <span id="equipmentReturnedCount" class="fw-bold text-dark">—</span></small>
                      </div>
                      <div class="d-flex align-items-center mb-2">
                        <div class="rounded-circle me-2" style="width: 8px; height: 8px; background-color: #17a2b8;"></div>
  ...
  <script src="../../../../public/assets/js/admin/navigation.js?v=20260315-5"></script>
  <script src="../../../../public/assets/js/admin/dashboard-live-data.js?v=20260315-5"></script>
  </body>
</html>
