...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderActiveFilters() {
    ...
    if (search) chips.push('<span class="nr-filter-chip"><i class="fa fa-search" aria-hidden="true"></i>' + escapeHtml(search) + '</span>');
    if (fromStr) chips.push('<span class="nr-filter-chip"><i class="fa fa-calendar" aria-hidden="true"></i>From: ' + escapeHtml(fromStr) + '</span>');
    if (toStr) chips.push('<span class="nr-filter-chip"><i class="fa fa-calendar" aria-hidden="true"></i>To: ' + escapeHtml(toStr) + '</span>');
