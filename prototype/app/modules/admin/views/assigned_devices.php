          ...
          <div class="card">
            <div class="card-body">
              <div class="row align-items-center mb-4 header-logos">
                <div class="col-md-2">
                  <img src="../../../../public/assets/images/denr-logo.png" alt="DENR Logo" class="header-logo-image">
                </div>
                ...
                <div class="col-md-2 text-end">
                  <img src="../../../../public/assets/images/bagong-pilipinas-logo.png" alt="Bagong Pilipinas Logo" class="header-logo-image">
                </div>
              </div>
