...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/property_custodian/equipment_management.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
  
</head>
<body data-preloaded-users="<?php echo htmlspecialchars(json_encode($preloadedUsers, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
    <!-- Sidebar -->
  ...
  <div class="print-container" id="printContainer">
    ...
    <div class="print-footer" style="margin-top:12px;">
      <div style="font-size:11px;">
        ...
        &nbsp;&nbsp;|&nbsp;&nbsp; <strong>Filter:</strong> <span id="footerFilter">All</span>
        &nbsp;&nbsp;|&nbsp;&nbsp; <strong>Generated:</strong> <span id="footerDate"></span>
      </div>
      <div class="print-signatures">
        <div class="print-sign-box">
          <div class="print-sign-label">Prepared By</div>
          <div class="print-sign-role">Property Custodian</div>
        </div>
        <div class="print-sign-box">
          <div class="print-sign-label">Checked By</div>
          <div class="print-sign-role">Administrative Officer</div>
        </div>
        <div class="print-sign-box">
          <div class="print-sign-label">Approved By</div>
          <div class="print-sign-role">CENRO Officer</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="../../../../public/assets/js/property_custodian/equipment_management.js"></script>
</body>
</html>
