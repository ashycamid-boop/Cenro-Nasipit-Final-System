...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/office_staff/service_requests.css">
...
<body>
      ...
      <div class="main-content">
        <div class="container-fluid p-2">
          ...
          <div class="row mb-4 g-3 align-items-end">
            <!-- Search -->
            <div class="col-md-3">
              <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" class="form-control sr-filter-input" placeholder="Search">
            </div>
            <!-- Date From -->
            <div class="col-md-2">
              <input type="date" name="date_from" value="<?php echo htmlspecialchars($dateFrom); ?>" class="form-control sr-filter-input" onkeydown="return false;" onpaste="return false;" onclick="this.showPicker && this.showPicker()">
            </div>
            <!-- Date To -->
            <div class="col-md-2">
              <input type="date" name="date_to" value="<?php echo htmlspecialchars($dateTo); ?>" class="form-control sr-filter-input" onkeydown="return false;" onpaste="return false;" onclick="this.showPicker && this.showPicker()">
            </div>
            <!-- Apply Button -->
            <div class="col-md-1">
              <button type="submit" class="btn btn-primary w-100 sr-btn-apply">Apply</button>
            </div>
            <!-- Clear Button -->
            <div class="col-md-1">
          ...
          <div class="row mb-3">
            <div class="col-12 d-flex justify-content-end">
              <a href="new_requests.php" class="btn btn-primary sr-btn-new">
                + New Request
              </a>
            </div>
          </div>
                          ...
                          <?php foreach ($service_requests as $req): ?>
                            <tr>
                              ...
                              <td>
                                ...
                                ?>
                                <span class="badge sr-status-badge" style="background-color: <?php echo htmlspecialchars($badgeColor); ?>;"><?php echo htmlspecialchars($displayStatus); ?></span>
                              </td>
                              <td>
  ...
  <script src="../../../../public/assets/js/office_staff/service_requests.js"></script>
  </body>
</html>
