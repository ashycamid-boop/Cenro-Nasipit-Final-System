...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcement_officer/case_details.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
</head>
<body data-report-id="<?php echo (int)($report['id'] ?? 0); ?>" data-update-status-url="<?php echo htmlspecialchars(build_file_url('app/modules/enforcement_officer/actions/update_status.php'), ENT_QUOTES, 'UTF-8'); ?>">
<div class="layout">
    <!-- Sidebar -->
                  ...
                  <?php for ($pi = 0; $pi < count($apprehended_persons); $pi++): $p = $apprehended_persons[$pi]; ?>
                    ...
                    <tr>
                      ...
                      <?php
                        ...
                        $personStatusStyle = $isConvitedStyle ? 'background:#000 !important;color:#fff !important;padding:0.35em 0.65em !important;border-radius:0.375rem !important;' : '';
                      ?>
                      <td>
                        <?php if (trim((string)$person_status) !== ''): ?>
                          <span class="badge <?php echo $personBadge; ?>" id="person-status-<?php echo $person_id; ?>" style="<?php echo htmlspecialchars($personStatusStyle, ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($personStatusDisplay); ?></span>
                        <?php else: ?>
