...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateFilterChips(search, role, officeUnit) {
        ...
        const chips = [];
        if (search) chips.push('<span class="assignments-filter-chip"><i class="fa fa-search"></i>' + escapeHtml(search) + '</span>');
        if (role) chips.push('<span class="assignments-filter-chip"><i class="fa fa-user-tag"></i>' + escapeHtml(role) + '</span>');
        if (officeUnit) chips.push('<span class="assignments-filter-chip"><i class="fa fa-building"></i>' + escapeHtml(officeUnit) + '</span>');
        assignmentsActiveFilterChips.innerHTML = chips.join('');
    }
