...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/admin/edit_requests_ongoing.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
</head>
<body class="property-custodian-edit-requests-ongoing-page" data-current-user-id="<?php echo htmlspecialchars((string)($sessionUserId ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
  ...
  <script src="../../../../public/assets/js/admin/edit_requests_ongoing.js"></script>
</body>
</html>
